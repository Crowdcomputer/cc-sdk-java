...
public class CroCoClient {
    ...
    private JSONObject createHumanTask(Long process, String title,
        ...
        if (parameters != null) {
            ...
            pars.put("parameters", "{}");
        log.debug(process);
        log.debug(UriBuilder.fromUri(Endpoints.CCTASK_CREATE).build(process));
        return (JSONObject) caller.postCall(
    ...
    public JSONObject stopTaskTactic(Long id) {
        // string or json?
        HashMap<Object, Object> pars = new HashMap<Object, Object>();
        return (JSONObject) caller.postCall(
    ...
    public JSONObject finishTaskTactic(Long id) {
        ...
        HashMap<Object, Object> pars = new HashMap<Object, Object>();
        return (JSONObject) caller.postCall(
                UriBuilder.fromUri(Endpoints.T_TASK_FINISH).build(id), pars);
    }
    ...
    public JSONObject stopTaskInstance(Long idtask, Long idinstance) {
        // string or json?
        HashMap<Object, Object> pars = new HashMap<Object, Object>();
        return (JSONObject) caller.postCall(
                UriBuilder.fromUri(Endpoints.T_INSTANCE_STOP).build(idtask, idinstance), pars);
    }

    public JSONObject startTaskInstance(Long idtask, Long idinstance) {
        // string or json?
        HashMap<Object, Object> pars = new HashMap<Object, Object>();

        return (JSONObject) caller.postCall(
                UriBuilder.fromUri(Endpoints.T_INSTANCE_START).build(idtask, idinstance), pars);
    }
    ...
    public JSONObject getQuality(Long idtask, Long idinstance) {
        ...
        return (JSONObject) caller.getCall(
                UriBuilder.fromUri(Endpoints.T_QUALITY_GET).build(idtask, idinstance));
    }

    public JSONObject rejectReward(Long idtask, Long idinstance) {
        // string or json?
        HashMap<Object, Object> pars = new HashMap<Object, Object>();
        return (JSONObject) caller.postCall(
